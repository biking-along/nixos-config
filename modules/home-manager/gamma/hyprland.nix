  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mod, o, workspace, +2"
        "$mod, i, workspace, -2"
        "$mod SHIFT, O, workspace, +2"
        "$mod SHIFT, I, workspace, +2"
        "$mod, U, focusmonitor, +1"
        "$mod SHIFT, U, movewindow, mon:+1 silent"
        "$mod CONTROL, U, movewindow, mon:+1"
        ...
        "$mod SHIFT , RETURN, movetoworkspace, +2"
        "$mod CONTROL, RETURN, movetoworkspace, -2"
