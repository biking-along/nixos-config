let
  epsilon = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFX3+SiHJ3PBe8BK54+utXlAKr3bAhTonf35+aui6+ze";
  ...
  fleet = [epsilon lambda gamma kappa omicron];
in {
  "traefik.env.age".publicKeys = fleet;
  "traefikEpsilon.env.age".publicKeys = fleet;
